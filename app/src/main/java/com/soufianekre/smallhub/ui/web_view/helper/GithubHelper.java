...
import com.soufianekre.smallhub.data.models.GithubNameParser;
...
public class GithubHelper {
    ...
    @NonNull private static String parseReadme(@NonNull String source, @NonNull String baseUrl, boolean isWiki) {
        // setup the user info & repo info
        GithubNameParser githubNameParser = new GithubNameParser(baseUrl);
        String owner = githubNameParser.getUsername();
        String repoName = githubNameParser.getName();
