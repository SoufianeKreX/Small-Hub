package com.soufianekre.smallhub.ui.widgets.contributions;
...
import com.soufianekre.smallhub.ui.widgets.contributions.utils.ColorsUtils;
import com.soufianekre.smallhub.ui.widgets.contributions.utils.DatesUtils;
...
public class GitHubContributionsView extends View {
    ...
    private void initAttributes(TypedArray attributes) {
        ...
        backgroundBaseColor = attributes.getColor(R.styleable.GitHubContributionsView_backgroundBaseColor,
                backgroundBaseColor);
    ...
    public Bitmap drawOnCanvas(List<ContributionsDay> contributionsFilter, List<ContributionsDay> contributions) {
        ...
        if (bitmap == null) {
            ...
            canvas1.drawRect(0, (topMargin + monthTextHeight),
                    width, height + monthTextHeight, blockPaint);
            ...
            for (ContributionsDay day : contributionsFilter) {
                ...
                if (DatesUtils.isFirstDayOfWeek(day.year, day.month, day.day + 1)) {
                    ...
                    if (DatesUtils.isFirstWeekOfMount(day.year, day.month, day.day + 1)) {
                        canvas1.drawText(DatesUtils.getShortMonthName(day.year, day.month, day.day + 1),
                                x, monthTextHeight,
                                monthTextPaint);
                    }
